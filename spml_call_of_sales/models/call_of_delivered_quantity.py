...
class TenderDeliveredQuantity(models.Model):
    _name = "call.of.delivered.quantity"
    _rec_name = 'sale_id'

    tender_sales_id = fields.Many2one("call.of.sales.lines")
    ...
    tender_delivered_ids = fields.One2many("call.of.delivered.quantity.lines", "tender_delivered_id")
...
class TenderDeliveredQuantityLines(models.Model):
    _name = "call.of.delivered.quantity.lines"

    tender_delivered_id = fields.Many2one("call.of.delivered.quantity")
